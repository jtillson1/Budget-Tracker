...
const request = indexedDB.open('budget-trakcer', 1);
...
//We need to create a function that will handle 
//collecting all of the data from the new_pizza object 
//store in IndexedDB and POST it to the server
